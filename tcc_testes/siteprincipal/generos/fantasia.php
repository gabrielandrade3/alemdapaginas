...
$sqlGenero = "SELECT id FROM generos WHERE nome = 'Fantasia' LIMIT 1";
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Serifadas+Elegantes:wght@400;700&display=swap" rel="stylesheet">
        ...
        <section id="fantasia">
        <h2>Fantasia</h2><!-- ESTA LINHA ESTAVA FALTANDO -->
        <div id="livros-fantasia" class="book-list">
            <?php if (mysqli_num_rows($resultLivros) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="mensagem">Nenhum livro encontrado para o gênero Fantasia.</p>
            <?php endif; ?>
        </div>
    </section>
</body>
