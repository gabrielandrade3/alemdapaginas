...
$sqlGenero = "SELECT id FROM generos WHERE nome = 'Ficção Científica' LIMIT 1";
...
<head>
    ...
    <link rel="stylesheet" href="ficientifica.css">
...
<body>
    <section id="ficientifica">
        <h2>Ficção Científica</h2>
        <div id="livros-ficientifica" class="book-list">
            <?php if (mysqli_num_rows($resultLivros) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="mensagem">Nenhum livro encontrado para o gênero Ficção Científica.</p>
            <?php endif; ?>
        </div>
    </section>
</body>
