...
$sqlGenero = "SELECT id FROM generos WHERE nome = 'Poesia' LIMIT 1";
...
<body>
    <section id="poesia">
        <h2>Poesia</h2>
        <div id="livros-poesia" class="book-list">
            <?php if (mysqli_num_rows($resultLivros) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="mensagem">Nenhum livro encontrado para o gênero Poesia.</p>
            <?php endif; ?>
        </div>
    </section>
</body>
