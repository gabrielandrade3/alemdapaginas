...
$sqlGenero = "SELECT id FROM generos WHERE nome = 'Romance' LIMIT 1";
...
<body>
    <section id="romance">
        <h2>Romance</h2>
        <div id="livros-romance" class="book-list">
            <?php if (mysqli_num_rows($resultLivros) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="mensagem">Nenhum livro encontrado para o gênero Romance.</p>
            <?php endif; ?>
        </div>
    </section>
</body>
