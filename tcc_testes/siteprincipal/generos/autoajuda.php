...
$sqlGenero = "SELECT id FROM generos WHERE nome = 'Autoajuda' LIMIT 1";
...
<head>
    <meta charset="UTF-8">
    <title>Livros de Autoajuda</title>
    <link rel="stylesheet" href="autoajuda.css">
...
<body>
    <section id="autoajuda">
        <h2>Autoajuda</h2>
        <div id="livros-autoajuda" class="book-list">
            <?php if (mysqli_num_rows($resultLivros) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="mensagem">Nenhum livro encontrado para o gênero Autoajuda.</p>
            <?php endif; ?>
        </div>
    </section>
</body>
