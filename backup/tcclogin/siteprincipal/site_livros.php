        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="https://quiz-de-g-nero--averagegrass2866494.on.websim.ai/?v=17">Quiz</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/tcclogin/index.html">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/tcclogin/cadastro2.html">Cadastro</a>
                    </li>
                </ul>
